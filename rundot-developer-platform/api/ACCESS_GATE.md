...
The Access Gate sits in front of sensitive SDK methods — AI, ImageGen, SpriteGen, Rooms, and UGC write operations — and blocks anonymous users from calling them. When a gated method is invoked:
