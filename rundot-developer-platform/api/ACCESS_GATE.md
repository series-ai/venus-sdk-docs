...
The Access Gate sits in front of sensitive SDK methods (TextGen, ImageGen, AudioGen, SpriteGen, ThreeDGen, Rooms, and UGC write operations) and blocks anonymous users from calling them. When a gated method is invoked:
