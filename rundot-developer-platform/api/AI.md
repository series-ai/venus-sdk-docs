...
```bash
npm install @series-inc/rundot-agent
```
...
const session = await agent.openSession('assistant')
...
Full documentation ships with the package: <https://www.npmjs.com/package/@series-inc/rundot-agent>.
