...
Each chunk is one of three variants:
...
- `textGen.requestChatCompletionAsync` and `textGen.requestChatCompletionStreamAsync` are subject to per-creator rate-limit tiers; see [Rate Limits](RATE_LIMITS.md).
