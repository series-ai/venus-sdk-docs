# Avatar 3D API (DEPRECATED)

{% hint style="danger" %}
**DEPRECATED**: The 3D Avatar API is deprecated and will be retired in a future platform release. New games should not implement this API. To build customizable characters in your game, use procedural meshes (e.g. Three.js BoxGeometry) or import custom GLTF/GLB models directly into your game bundle.
{% endhint %}
