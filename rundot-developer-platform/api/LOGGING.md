...
Stream logs to the RUN.game host for debugging and support. The logging API mirrors `console.log`/`console.error` semantics while tagging messages with your game instance.
