...
const skus = await RundotGameAPI.iap.listDirectPurchaseSkus(gameId)
...
{% hint style="info" %}
On the RUN app the host scopes the catalog to **your** game regardless of the `gameId` argument — you cannot list another game's items.
