...
- Text generation (`textGen.requestChatCompletionAsync`) and image generation (`imageGen.generate`) — gated separately and may refuse at lower rates. Design these calls assuming they can fail, and keep your game playable when they do.
