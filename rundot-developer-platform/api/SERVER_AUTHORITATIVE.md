...
> ⚠️ The Server-Authoritative API only runs inside the RUN.game host environment. Calling these methods during local Playground testing throws a helpful error.
