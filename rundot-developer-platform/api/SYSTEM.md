...
| Safari 16.4 or later | Host document fullscreen | Supported when the unprefixed Pointer Lock API is available |
| Mobile web | Host document fullscreen when the unprefixed API is available | Combined mode works only when Pointer Lock is available |
