...
| Option | Type | Description |
|--------|------|-------------|
| `should_texture` | `boolean` | Generate textures for the mesh |
| `enable_pbr` | `boolean` | Generate PBR materials |
| `ai_model` | `string` | Select the Meshy model variant |
