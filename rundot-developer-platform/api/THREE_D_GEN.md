...
|-------|-----------|-----|---------|
| **Generate** | `pixal3d`, `hunyuan3d-v3.1-pro`, `trellis-2`, `meshy`, `tripo-v2.5` | fal.ai | Create base 3D model from image or text |
...
|-----------|------|-------------|
| `provider` | `ThreeDGenProvider` | Required: `'pixal3d'`, `'hunyuan3d-v3.1-pro'`, `'trellis-2'`, `'meshy'`, or `'tripo-v2.5'` |
...
| `additionalViews` | `object` | Hunyuan image-to-3d only. Extra view URLs: `backImageUrl`, `leftImageUrl`, `rightImageUrl`, `topImageUrl`, `bottomImageUrl` |
...
- Text-to-3d mode is supported by `hunyuan3d-v3.1-pro`, `meshy`, and `tripo-v2.5`.
