...
models appear without an SDK or CLI release. At time of writing:
`seedance-2.0` (default), `seedance-2.0-fast`, `seedance-2.0-v2-fast` (enterprise/v2 fast tier),
`kling-3.0-standard`. The live set is served by `GET /v1/videogen/models`.
