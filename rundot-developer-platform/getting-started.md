...
This walks you through naming and configuring your game for the RUN.game platform. It creates a `game.config.{env}.json` file that stores your game ID and build settings.
