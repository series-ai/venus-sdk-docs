...
Run paid ad campaigns for your game straight from the `rundot` CLI. You write a short prompt, RUN.game generates the source ad creatives for you, and a campaign is submitted to Meta (Facebook / Instagram) to drive new players to your game.
...
rundot marketing generate  →  RUN.game generates source ad creatives (AI)
