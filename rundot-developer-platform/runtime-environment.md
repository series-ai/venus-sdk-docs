...
RUN.game signs players in and hands your game their identity, so you don't build or run a login yourself. The platform is the only supported auth system.
